            ...
            <div class="card-body">
                ...
                <img src="cg.svg">
                    <h1 class="bt">用户创建成功！</h1>
                        ...
                        <a href="https://ltyun.top/console/HelpCenter.php" class="btn btn-info" role="button" id="jc">查看教程</a>
                        <a href="https://ltyun.top/xzwj/" class="btn btn-info" role="button" id="xz">下载RD</a>

                    <br><a class="bq">由 蓝天新世界 提供开源技术 v2.0</a>
...
<script>
        document.addEventListener("DOMContentLoaded", function() {
            const registerButton = document.getElementById('jc');
    ...
    <script>
    document.addEventListener("DOMContentLoaded", function() {
        const recoverButton = document.getElementById('xz');
        const fullHeightDiv = document.querySelector('.full-height');
